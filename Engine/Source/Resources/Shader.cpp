...
namespace NL
{
	...
	void Shader::SetUniformFloat2(const std::string& name, const nlm::vec2& value)
	{
		glUniform2f(GetUniformLocation(name), value.x, value.y);
	}

	void Shader::SetUniformFloat3(const std::string& name, const nlm::vec3& value)
	{
		glUniform3f(GetUniformLocation(name), value.x, value.y, value.z);
	}

	void Shader::SetUniformFloat4(const std::string& name, const nlm::vec4& value)
	{
		glUniform4f(GetUniformLocation(name), value.x, value.y, value.z, value.w);
	}

	void Shader::SetUniformMat4(const std::string& name, const nlm::mat4& value)
	{
		// GL_FALSE£∫¡–”≈œ»æÿ’Û
