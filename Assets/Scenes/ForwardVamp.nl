Scene: Untitled
Entities:
  - ID: 17351281922618116661
    Name: Entity
    TransformComponent:
      Translation: [0, 2.46079898, 2.03615284]
      Rotation: [2.14676309, 0, 0]
      Scale: [1, 1.00000525, 1.00000548]
    LightComponent:
      LightType: 0
      Color: [1, 1, 1]
      Intensity: 1
      Attenuation: [1, 0.699999988, 1.79999995]
  - ID: 14059246497174356439
    Name: Entity
    TransformComponent:
      Translation: [0, 0, 0]
      Rotation: [0, 0, 0]
